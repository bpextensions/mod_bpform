...
<div class="bpform-container">
    ...
    <div class="form-data">
        ...
        foreach ($data as $name => $data_record): ?>
            ...
            <?php
            if ($data_record->type === 'group'): ?>
                <h2 class="h5"><?php
                    echo $data_record->title ?></h2>
                <table>
                    <tbody>
                    <?php
                    foreach ($data_record->subfields as $field): ?>
                        <tr>
                            <?php
                            require ModuleHelper::getLayoutPath('mod_bpform', $layout . '_mail_fields') ?>
                        </tr>
                    <?php
                    endforeach ?>
                    </tbody>
